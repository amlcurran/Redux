package com.espiandev.redux.cast.mediarouterplus;/*
 ...
 * to select by specifying a {@link android.support.v7.media.MediaRouteSelector selector} with the
 ...
 * a {@link android.support.v7.app.MediaRouteChooserDialog} to allow the user to select a route.
 ...
 * on the button opens a {@link android.support.v7.app.MediaRouteControllerDialog} to allow the user
 ...
 * {@link android.support.v4.app.FragmentActivity} from the <code>android.support.v4</code>
 * support library.  Refer to support library documentation for details.
 * </p>
 *
 * @see android.support.v7.app.MediaRouteActionProvider
 * @see #setRouteSelector
 */
public class MediaRouteButtonPlus extends View {
    private static final String TAG = "MediaRouteButtonPlus";
    ...
    public MediaRouteButtonPlus(Context context) {
        this(context, null);
    }
    ...
    public MediaRouteButtonPlus(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMinHeight = a.getDimensionPixelSize(
                R.styleable.MediaRouteButtonPlus_android_minHeight, 0);
        a.recycle();
    ...
    public void setRouteSelector(MediaRouteSelector selector) {
        ...
        if (mRouter == null) {
            throw new IllegalArgumentException("mediaRouter must not be null");
        }
